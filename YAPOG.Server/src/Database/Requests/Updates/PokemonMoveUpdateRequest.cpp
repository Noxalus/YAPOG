...
#include "Database/Requests/Updates/PokemonMoveUpdateRequest.hpp"

namespace yse
{
  PokemonMoveUpdateRequest::PokemonMoveUpdateRequest 
    (const PokemonMoveTable& pokemonTable)
    : pokemonTable_ (pokemonTable)
  {
  }

  bool PokemonMoveUpdateRequest::Update 
